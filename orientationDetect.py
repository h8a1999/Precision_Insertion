...
class detectOrientation:
    def __init__(self):
        ...
        # PCB variables
        self.refPointLength = 60
        self.pcbLeftCentroids = []
        self.pcbRightCentroids = []
        self.referencePointOnPcb = []
    ...
    #######################################################
    ############ Reference point     ######################
    def determineRefPoint(self, x, y, imShape, angle):
        ...
        xtemp[0] = x0+ self.refPointLength#x0+500
        xtemp[1] = y0
        
        self.referencePointOnPcb = self.rotateCoordinates((xtemp[1] - y0), (xtemp[0] - x0), x0, y0, angle)
        

        return self.referencePointOnPcb
    ...
    def drawRefPoint(self, frame):
      cv2.circle(frame,self.referencePointOnPcb, 10, (0, 0, 0),3 )
    ...
    def computeOrientations(self, frame):
        ...
        self.determineRefPoint(self.pcbRightCentroids[0], self.pcbLeftCentroids[0], frame.shape[:2], self.baseOrientationDegs)
